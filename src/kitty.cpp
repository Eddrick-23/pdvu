...
std::string get_image_sequence(const std::string &filepath, int img_id,
  ...
  if (transmit) {
    ...
    sequence +=
        std::format("\x1b_Ga=t,q=2,i={},t={},f=24,s={},v={};{}"
                    "\x1b\\",
                    img_id, transmission_medium == "shm" ? "s" : "f", img_width,
                    img_height, kitty::detail::base64_encode(filepath));
  }
  sequence += std::format( // read and display
      "\x1b_Ga=p,q=2,i={},p={},C=1,z={},x={},y={},w={},h={}{}{}\x1b\\", img_id,
      img_id, IMAGE_Z,
...
std::string get_dim_layer(int term_width, int term_height) {
  ...
  // transparency
  std::string result =
      std::format("\x1b_Ga=T,q=2,f=32,C=1,z={},s={},v={},c={},r={},x={},y={},w="
                  "{},h={};{}\x1b\\",
